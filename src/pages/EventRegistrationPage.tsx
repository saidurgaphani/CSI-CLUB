  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        onClick={handleBack}
        className="absolute top-6 left-6 z-10 bg-surface/80 backdrop-blur-md hover:bg-surface border border-border rounded-xl px-4 py-2 text-textSecondary hover:text-text transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2"
      >
        ...
        >
          ...
          {eventDetails && (
            <motion.div
              ...
              className="bg-surface/80 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-2xl border border-border/50 mb-8"
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div>
                  <motion.h1
                    ...
                    className="text-3xl md:text-4xl font-bold text-text mb-2 bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent"
                  >
                    {eventDetails.title || 'Event Registration'}
                  </motion.h1>
                  {eventDetails.description && (
                    <p className="text-textSecondary text-lg whitespace-pre-line" style={{ whiteSpace: 'pre-line', lineHeight: '1.6' }}>
                      {eventDetails.description}
                    </p>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {eventDetails.venue_location && (
                  <motion.a
                    ...
                    variants={itemVariants}
                    className="flex items-center gap-3 p-4 bg-accent/5 rounded-xl border border-accent/20 hover:bg-accent/10 transition-all duration-300 group"
                  >
              ...
              {eventDetails.details && (
                <motion.div
                  variants={itemVariants}
                  className="mt-6 p-6 bg-background/50 rounded-2xl border border-border/50"
                >
          ...
          {eventDetails?.iframe ? (
            <motion.div
              variants={itemVariants}
              className="bg-surface/80 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-border/50"
            >
              <div className="mb-6">
                <h2 className="text-2xl md:text-3xl font-bold text-text mb-2 bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">
                  Registration Form
                </h2>
                <p className="text-textSecondary">Please fill out the form below to register for this event</p>
              </div>
              <div
